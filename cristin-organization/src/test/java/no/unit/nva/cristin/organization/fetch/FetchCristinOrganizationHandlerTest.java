...
class FetchCristinOrganizationHandlerTest {
  ...
  public static final String CRISTIN_UNITS_URI =
      "https://api.cristin-test.uio.no/v2/units?id=185.53.18.14";
  public static final String ENGLISH_LANGUAGE_KEY = "en";
  public static final String DEPARTMENT_OF_MEDICAL_BIOCHEMISTRY =
  ...
  public static final String CRISTIN_GET_RESPONSE_SUB_UNITS_JSON =
      "cristinGetResponseSubUnits.json";
  public static final String CRISTIN_GET_RESPONSE_SUB_UNITS_SORTED_JSON =
      "cristinGetResponseSubUnitsSorted.json";
  ...
  public static final String ERROR_MESSAGE_NOT_FOUND =
      "The requested resource 'https://api.dev.nva.aws.unit.no/cristin/organization/1.0.0.0' was"
          + " not found";
  ...
  void setUp() throws ApiGatewayException {
    ...
    doReturn(Try.of(new HttpResponseFaker(EMPTY_JSON)))
        .when(cristinApiClient)
        .sendRequestMultipleTimes(any());
    fetchOrgClient20230526 = new FetchCristinOrgClient20230526(mockHttpClient);
    fetchOrgClient20230526 = spy(fetchOrgClient20230526);
    doReturn(new HttpResponseFaker(EMPTY_JSON)).when(fetchOrgClient20230526).fetchGetResult(any());
    ...
    fetchCristinOrganizationHandler =
        new FetchCristinOrganizationHandler(clientProvider, new Environment());
  }
  ...
  void shouldReturnsNotFoundResponseWhenUnitIsMissing() throws IOException {
    ...
    fetchCristinOrganizationHandler =
        new FetchCristinOrganizationHandler(clientProvider, new Environment());
    fetchCristinOrganizationHandler.handleRequest(
        generateHandlerRequest(NON_EXISTING_IDENTIFIER), output, context);
  ...
  void shouldReturnsBadRequestResponseOnEmptyInput() throws IOException {
    ...
    assertThat(
        actualDetail, containsString(ERROR_MESSAGE_INVALID_PATH_PARAMETER_FOR_ID_FOUR_NUMBERS));
  }

  @Test
  void shouldReturnBadRequestResponseOnIllegalIdentifierInPath() throws IOException {
    var inputStream =
        new HandlerRequestBuilder<>(restApiMapper)
            .withBody(null)
            .withHeaders(null)
  ...
  void shouldReturnOrganizationHierarchy() throws IOException, ApiGatewayException {
    ...
    fetchCristinOrganizationHandler.handleRequest(
        generateHandlerRequest(identifier), output, context);
    ...
    assertThat(
        actualOrganization.getLabels().get(ENGLISH_LANGUAGE_KEY),
  ...
  void shouldReturnOrganizationFlatHierarchy() throws IOException {
    ...
    final var identifier = "185.53.18.14";
    fetchCristinOrganizationHandler.handleRequest(
        generateHandlerRequestWithAdditionalQueryParameters(identifier, NONE), output, context);
    var gatewayResponse = GatewayResponse.fromOutputStream(output, Organization.class);
  ...
  @Test
  void shouldNotCallUpstreamOneMoreTimeForFetchingSubunitsWhenSendingParamDepthWithValueNone()
      throws Exception {
    ...
    fetchCristinOrganizationHandler =
        new FetchCristinOrganizationHandler(clientProvider, new Environment());
    fetchCristinOrganizationHandler.handleRequest(
        requestUsingV20230526(QUERY_PARAM_NO_DEPTH), output, context);
  ...
  @ParameterizedTest(
      name =
          "Requesting payload using version 20230526 with depth value {0} should return "
              + "correct payload")
  @MethodSource("depthAndCorrespondingPayloadArgumentProvider")
  void shouldReturnCorrectPayloadBasedOnQueryParamDepthWhenRequestingVersion20230526(
      String depth, String cristinPayload, String cristinSubsPayload, String expectedResult)
      throws Exception {

    doReturn(new HttpResponseFaker(cristinPayload))
        .doReturn(new HttpResponseFaker(cristinSubsPayload))
        .when(fetchOrgClient20230526)
        .fetchGetResult(any());
    fetchCristinOrganizationHandler =
        new FetchCristinOrganizationHandler(clientProvider, new Environment());
  ...
  void shouldReturnVersion20230526AsDefault() throws IOException, ApiGatewayException {
    ...
    doReturn(fakeHttpResponse)
        .doReturn(fakeSubUnitResponse)
        .when(fetchOrgClient20230526)
        .fetchGetResult(any());
    ...
    fetchCristinOrganizationHandler =
        new FetchCristinOrganizationHandler(clientProvider, new Environment());
    fetchCristinOrganizationHandler.handleRequest(
        generateHandlerRequest(SOME_IDENTIFIER), output, context);
  ...
  @Test
  void shouldReturnsNotFoundResponseWhenUpstreamReturnNotFoundAndVersionIs20230526()
      throws Exception {
    ...
    doReturn(fakeHttpResponse)
        .doReturn(fakeSubUnitHttpResponse)
        .when(fetchOrgClient20230526)
        .fetchGetResult(any());
  ...
  void shouldNotDisplayHasPartFieldWhenDepthNotWanted() throws Exception {
    ...
    fetchCristinOrganizationHandler =
        new FetchCristinOrganizationHandler(clientProvider, new Environment());
    fetchCristinOrganizationHandler.handleRequest(
        generateHandlerRequestWithoutDepth(), output, context);
  ...
  void shouldReturnHitsInSortedOrderForVersion20230526() throws Exception {
    doReturn(new HttpResponseFaker(getFromResources(CRISTIN_GET_RESPONSE_JSON)))
        .doReturn(
            new HttpResponseFaker(getFromResources(CRISTIN_GET_RESPONSE_SUB_UNITS_SORTED_JSON)))
        .when(fetchOrgClient20230526)
        .fetchGetResult(any());
    fetchCristinOrganizationHandler =
        new FetchCristinOrganizationHandler(clientProvider, new Environment());
  ...
  @Test
  void shouldDoAnExtraRequestWhenUpstreamHasHeaderIndicatingMoreHitsThanFirstPage()
    ...
    var cristinSubsPayload = getFromResources(CRISTIN_GET_RESPONSE_SUB_UNITS_JSON);
    var fakeSubUnitResponse =
        new HttpResponseFaker(cristinSubsPayload, HTTP_OK, headersIndicatingMoreResults);

    var cristinAdditionalSubsPayload =
        getFromResources(CRISTIN_GET_RESPONSE_ADDITIONAL_SUB_UNITS_JSON);
    var fakeAdditionalSubUnitResponse =
        new HttpResponseFaker(cristinAdditionalSubsPayload, HTTP_OK);

    doReturn(fakeHttpResponse)
        .doReturn(fakeSubUnitResponse)
        .doReturn(fakeAdditionalSubUnitResponse)
        .when(fetchOrgClient20230526)
        .fetchGetResult(any());
  ...
  private boolean containsIdentifier(Organization actualOrg, String identifier) {
    return actualOrg.getHasPart().stream()
  ...
  private InputStream generateHandlerRequest(String organizationIdentifier)
  ...
  private InputStream generateHandlerRequestWithAdditionalQueryParameters(
      String organizationIdentifier, String depth) throws JsonProcessingException {
    var headers = Map.of(CONTENT_TYPE, MediaTypes.APPLICATION_JSON_LD.toString());
    var pathParameters = Map.of(IDENTIFIER, organizationIdentifier);
  ...
  private InputStream requestUsingV20230526(Map<String, String> queryParameters)
      throws JsonProcessingException {
    var headers =
        Map.of(
            CONTENT_TYPE, MediaTypes.APPLICATION_JSON_LD.toString(),
  ...
  private InputStream generateHandlerRequestWithoutDepth() throws JsonProcessingException {
