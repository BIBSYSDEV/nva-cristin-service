...
public class OAuthLogin {
  ...
  public String getCode(String username, String password) {
    ...
    var response =
        attempt(() -> httpClient.send(request, HttpResponse.BodyHandlers.ofString())).orElseThrow();
  ...
  public String getAccessToken(String authorizationCode) {
    ...
    if (response.statusCode() == HttpStatusCode.OK) {
      ...
      logger.error(
          "Error exchanging authorization code for access token: {}", response.statusCode());
      return null;
    }
  }
}
