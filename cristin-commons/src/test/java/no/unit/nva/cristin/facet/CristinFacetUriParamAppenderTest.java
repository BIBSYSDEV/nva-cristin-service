...
class CristinFacetUriParamAppenderTest {
  ...
  private final URI uriWithMultipleFacetValues =
      URI.create(
          "https://api.cristin-test.uio.no/v2/persons/facets?name=aud&institution=ntnu&institution=uio"
              + "&sector=UC");
  private final URI uriWithSingleFacetValue =
      URI.create(
          "https://api.cristin-test.uio.no/v2/persons/facets?name=aud&institution=uio&sector=UC");

  private final URI uriWithAllFacetValues =
      URI.create(
          "https://api.cristin-test.uio.no/v2/persons/facets?name=aud"
              + "&category=PHD"
  ...
  void shouldDoNothingWhenNoParamsSent() {
    var actual = new CristinFacetUriParamAppender(originalUri, null).getAppendedUri().getUri();
  ...
  void shouldReturnOriginalUriWhenParamMapDoesNotContainFacetParams() {
    ...
    var actual = new CristinFacetUriParamAppender(originalUri, params).getAppendedUri().getUri();
