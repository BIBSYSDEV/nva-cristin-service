...
public class ErrorMessages {
  ...
  public static final String ERROR_MESSAGE_INVALID_PATH_PARAMETER_FOR_ID_FOUR_NUMBERS =
      "Invalid path parameter for identifier, needs to be organization identifier matching pattern"
          + " /(?:\\d+.){3}\\d+/, e.g. (100.0.0.0)";
  public static final String ALPHANUMERIC_CHARACTERS_DASH_COMMA_PERIOD_AND_WHITESPACE =
      "May only contain alphanumeric characters, dash, comma, period, colon, semicolon and"
          + " whitespace";
  public static final String ERROR_MESSAGE_DEPTH_INVALID =
      "Parameter 'depth' has invalid value. "
  ...
  public static final String ERROR_MESSAGE_INVALID_NUMBER =
  ...
  public static final String ERROR_MESSAGE_BACKEND_FAILED_WITH_STATUSCODE =
      "Remote service responded with status: %s when client called uri: %s. Body from upstream"
          + " returned: %s";
  ...
  public static final String ERROR_MESSAGE_UNSUPPORTED_CONTENT_TYPE =
      "%s contains no supported Accept header values. Supported values are: application/json;"
          + " charset=utf-8, application/ld+json";
  ...
  public static final String ERROR_MESSAGE_INVALID_PATH_PARAMETER =
      "Invalid path parameter for '%s'";
  ...
  public static final String UPSTREAM_BAD_REQUEST_RESPONSE =
      "Upstream returned 400 with response body: ";
  ...
  public static final String ERROR_MESSAGE_BACKEND_FAILED_WITH_EXCEPTION =
      "Remote service responded with error when client called uri: %s. Exception from upstream"
          + " returned: %s";
  ...
  public static String validQueryParameterNamesMessage(Set<String> queryParameters) {
    return String.format(
        ERROR_MESSAGE_TEMPLATE_INVALID_QUERY_PARAMETERS, prettifyList(queryParameters));
  }

  /**
   * Creates a error message containing which parameter that has invalid value and what the value is
   * supposed to be.
   *
   ...
   */
  public static String invalidQueryParametersMessage(
      String queryParameterName, String validValues) {
   ...
   * @return formatted string containing a message with allowed values for this parameter
   */
  public static String invalidQueryParametersMessageWithRange(
      String queryParameterName, String validValues) {
  ...
  private static String prettifyList(Set<String> queryParameters) {
    return queryParameters.size() > 1
        ...
        : queryParameters.stream().collect(Collectors.joining("", "'", "'"));
  }
}
