...
public class CristinInstitution {
  ...
  public Organization toOrganization() {
    ...
    return new Organization.Builder().withId(id).withLabels(getInstitutionName()).build();
  }
  ...
  public static CristinInstitution fromOrganization(Organization organization) {
    ...
    institution.setUrl(
        nvaIdentifierToCristinIdentifier(organization.getId(), INSTITUTION_PATH).toString());
