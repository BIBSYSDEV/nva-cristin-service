...
public class Constants {
  ...
  public static final Pattern ORCID_PATTERN =
      Pattern.compile("[0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{3}[0-9|Xx]");
  ...
  public static final String NOT_FOUND_MESSAGE_TEMPLATE =
      "The resource '%s' cannot be dereferenced";
  ...
  public static final String PERSON_QUERY_CONTEXT =
      "https://example.org/person-search-context.json";
