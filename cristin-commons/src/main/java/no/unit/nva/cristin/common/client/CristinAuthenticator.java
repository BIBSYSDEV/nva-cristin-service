...
/**
 * Creates an Authenticator to create a HttpClient with authentication for usage in ApiClient
 * requests to Cristin API.
 */
public class CristinAuthenticator {
  ...
  public static final String USING_A_BASIC_AUTH_HEADER =
      "Using basic auth header in upstream request";
