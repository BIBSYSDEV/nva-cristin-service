...
public class CristinOrganizationBuilder {
   ...
   */
  public static CristinOrganization fromOrganizationContainingInstitution(
   ...
   */
  public static Optional<CristinOrganization> fromOrganizationContainingUnitIfPresent(
      Organization organization) {
