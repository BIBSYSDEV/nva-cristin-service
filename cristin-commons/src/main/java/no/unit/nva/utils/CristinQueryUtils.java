...
public class CristinQueryUtils {
  ...
  /**
   * Converts param keys that are the same as facet param keys but has another name into same names
   * as facet param keys. Useful when wanting to use a version that has support for facets but also
   * has keys from another version that don't support facets but has equal content.
   */
  public static Map<String, String> convertSupportedParamKeysToFacetParamKeys(
