...
public class DateInfo implements JsonSerializable {
  ...
  @JsonCreator
  public DateInfo(
      @JsonProperty(SOURCE_SHORT_NAME) String sourceShortName, @JsonProperty(DATE) Instant date) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getSourceShortName(), dateInfo.getSourceShortName())
        && Objects.equals(getDate(), dateInfo.getDate());
  }
