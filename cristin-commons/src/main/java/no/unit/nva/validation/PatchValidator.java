...
public class PatchValidator {
  ...
  public static void validateLanguageUri(JsonNode jsonNode) throws BadRequestException {
    var languageUri =
        attempt(() -> URI.create(jsonNode.textValue()))
  ...
  protected static void validateInstantIfPresent(ObjectNode input, String propertyName)
   ...
   */
  public static void validateNotNullIfPresent(ObjectNode input, String propertyName)
      throws BadRequestException {
  ...
  public static void validateDescription(ObjectNode input, String fieldName)
      throws BadRequestException {
