...
public class QueryKeywordsApiClient extends ApiClient
  ...
  public static final String KEYWORD_CONTEXT_JSON =
  ...
  @Override
  public SearchResponse<Keyword> executeQuery(Map<String, String> params)
  ...
  private List<Keyword> getKeywords(HttpResponse<String> response) throws BadGatewayException {
    ...
    return cristinKeywords.stream().map(new KeywordFromCristin(null)).collect(Collectors.toList());
  }
