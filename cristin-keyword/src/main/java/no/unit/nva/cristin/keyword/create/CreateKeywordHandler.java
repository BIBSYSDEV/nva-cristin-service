...
public class CreateKeywordHandler extends ApiGatewayHandler<Keyword, Keyword> {
  ...
  public CreateKeywordHandler() {
    this(
        new Environment(), new CristinCreateKeywordApiClient(CristinAuthenticator.getHttpClient()));
  }

  public CreateKeywordHandler(Environment environment, CreateKeywordApiClient apiClient) {
  ...
  @Override
  protected void validateRequest(Keyword input, RequestInfo requestInfo, Context context)
      throws ApiGatewayException {
