...
public class CristinBiobankApiClient extends ApiClient {
  ...
  /**
   * Creates a wrapper object containing CristinBiobank transformed to Biobank with additional
   * metadata. Is used for serialization to the client.
   *
   ...
   */
  @JacocoGenerated
  public SearchResponse<Biobank> fetchBiobanksWithParameters(QueryBiobank query)
    ...
    final var processingTime =
        calculateProcessingTime(startRequestTime, System.currentTimeMillis());
  ...
  protected HttpResponse<String> httpRequestWithStatusCheck(QueryBiobank query)
      throws ApiGatewayException {
