...
public class Biobank implements JsonSerializable {
  ...
  public Biobank(
      ...
      BiobankType biobankType,
      Map<String, String> labels,
      String mainLanguage,
      Instant storeUntilDate,
      Instant startDate,
      String status,
      DateInfo created,
      DateInfo lastModified,
      URI coordinatingOrganization,
      URI coordinator,
      AssociatedProject project,
      Set<ExternalSource> externalSources,
      List<BiobankApproval> approvals,
