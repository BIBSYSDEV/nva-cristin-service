...
public class CristinBiobankClientMock extends CristinBiobankApiClient {
  ...
  public CristinBiobankClientMock() {
    this(
        IoUtils.stringFromResources(Path.of(CRISTIN_GET_BIOBANK_RESPONSE_JSON_FILE)),
  ...
  protected HttpResponse<String> httpRequestWithStatusCheck(QueryBiobank query)
    ...
    Predicate<String> containsBioBank =
        e -> e.contains(query.getValue(ParameterKeyBiobank.PATH_BIOBANK));
    var body =
