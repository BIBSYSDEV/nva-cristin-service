...
import no.unit.nva.doi.DataciteConnection;
import no.unit.nva.doi.SimpleResponse;
...
//    private static final Logger logger = LoggerFactory.getLogger(FetchDoiMetadata.class);
    ...
    public FetchCristinProjects(DataciteConnection dataciteConnection) {
    ...
    public SimpleResponse handleRequest(Map<String, Object> input, Context context) {
        ...
        String url = (String) queryStringParameters.get("query");
        logger.log("Incoming query:" + url+"\n");
