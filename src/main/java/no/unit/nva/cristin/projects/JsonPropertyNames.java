...
public class JsonPropertyNames {
    ...
    public static final String HRCS_ACTIVITIES = "hrcs_activities";
    public static final String ACADEMIC_DISCIPLINES = "academic_disciplines";
    ...
    public static final String FUNDING_SOURCE_NAME = "funding_source_name";
