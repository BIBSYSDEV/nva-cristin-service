...
public class QueryCristinProjectApiClientTest {
  ...
  @Test
  void getsCristinUriWithNoQueryParamWhenCallingUriBuilderWithTitleQueryRequested()
      throws Exception {
    final var params =
        QueryProject.builder()
  ...
  @Test
  void getsCristinUriWithProjectCodeParamWhenCallingUriBuilderWithGrantIdQueryRequested()
      throws Exception {
  ...
  protected URI generateCristinQueryProjectsUrl(Map<String, String> parameters)
      throws BadRequestException {
    return QueryProject.builder().fromQueryParameters(parameters).validate().build().toURI();
  }
}
