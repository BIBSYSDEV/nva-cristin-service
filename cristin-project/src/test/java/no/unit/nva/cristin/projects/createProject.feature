Feature: API tests for Cristin Project retrieve and search
  ...
  Background:
    ...
    * def minimalCreateRequestWithUnitIdentifiers =   { type: 'Project', title: 'Test Project', language: 'http://lexvo.org/id/iso639-3/nob', startDate: '2010-06-29T01:33:17.518Z',  coordinatingInstitution: {type: 'Organization',id: 'https://api.dev.nva.aws.unit.no/cristin/organization/20202.0.0.0'},contributors: [{type: 'ProjectManager',identity: {type: 'Person',id: 'https://api.dev.nva.aws.unit.no/cristin/person/515114'},affiliation: {type: 'Organization',id: 'https://api.dev.nva.aws.unit.no/cristin/organization/20202.0.0.0'}}]}
