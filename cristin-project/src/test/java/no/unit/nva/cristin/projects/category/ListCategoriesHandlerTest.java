...
class ListCategoriesHandlerTest {
  ...
  public static final String CRISTIN_CATEGORIES_RESPONSE_JSON =
      "cristinProjectCategoriesResponse.json";
  public static final String EXPECTED_CRISTIN_URI =
      "https://api.cristin-test.uio.no/v2/projects/categories";
  public static final String NVA_QUERY_CATEGORIES_RESPONSE_JSON =
      "nvaProjectCategoriesResponse.json";
  ...
  private GatewayResponse<SearchResponse> sendQuery() throws IOException {
    var input = new HandlerRequestBuilder<Void>(OBJECT_MAPPER).withBody(null).build();
