...
class QueryCristinOrganizationProjectHandlerTest {
  ...
  public static final String CRISTIN_QUERY_PROJECTS_RESPONSE_JSON_RESOURCE =
      "cristinQueryProjectsResponse.json";
  public static final String CRISTIN_GET_PROJECT_RESPONSE_JSON_RESOURCE =
      "cristinGetProjectResponse.json";
  ...
  void shouldReturnBadRequestResponseOnMissingPathParam() throws IOException {
    ...
    assertThat(
        actualDetail, containsString(ERROR_MESSAGE_TEMPLATE_REQUIRED_MISSING.substring(0, 34)));
  }
  ...
  void shouldReturnBadRequestResponseOnInvalidQueryParameters() throws IOException {
    ...
    assertThat(
        actualDetail,
        containsString(validQueryParameterNamesMessage(VALID_QUERY_PARAMETER_NVA_KEYS)));
  }

  @Test
  void shouldReturnResponseWithCorrectNumberOfResultsOnValidInput() throws Exception {
    var cristinListOfProjects =
        getStringFromResources(CRISTIN_QUERY_PROJECTS_RESPONSE_JSON_RESOURCE);
    var cristinProject = getStringFromResources(CRISTIN_GET_PROJECT_RESPONSE_JSON_RESOURCE);
    var fakeHttpQueryResponse =
        new HttpResponseFaker(cristinListOfProjects, HttpURLConnection.HTTP_OK);
    ...
    doReturn(CompletableFuture.completedFuture(fakeHttpEnrichResponse))
