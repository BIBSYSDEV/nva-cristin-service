...
public record CristinProjectSearchResponse(
    CristinProject[] data, Map<String, CristinFacet[]> facets)
    implements CristinSearchResponse<CristinProject[]> {

  @JsonCreator
  public CristinProjectSearchResponse(
      @JsonProperty("data") CristinProject[] data,
