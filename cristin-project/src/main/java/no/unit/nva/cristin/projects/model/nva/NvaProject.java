...
public class NvaProject implements JsonSerializable, UriId {
  ...
  @JsonProperty private URI language;
  ...
  @JsonProperty private List<Funding> funding;
  @JsonProperty private Organization coordinatingInstitution;
  @JsonProperty private List<NvaContributor> contributors;
  @JsonProperty private ProjectStatus status;
  @JsonProperty private Map<String, String> academicSummary;
  @JsonProperty private Map<String, String> popularScientificSummary;
  ...
  @JsonProperty private Map<String, String> method;
  @JsonProperty private Map<String, String> equipment;
  @JsonProperty private List<TypedLabel> projectCategories;
  @JsonProperty private List<TypedLabel> keywords;
  @JsonProperty private List<ExternalSource> externalSources;
  @JsonProperty private List<URI> relatedProjects;
  @JsonProperty private List<Organization> institutionsResponsibleForResearch;

  @JsonProperty
  @JsonInclude(NON_NULL)
  private HealthProjectData healthProjectData;

  @JsonProperty private List<Approval> approvals;
  ...
  public static final class Builder {
    ...
    public Builder withInstitutionsResponsibleForResearch(
        List<Organization> institutionsResponsibleForResearch) {
