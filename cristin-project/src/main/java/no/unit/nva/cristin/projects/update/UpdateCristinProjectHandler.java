...
public class UpdateCristinProjectHandler extends ApiGatewayHandler<String, Void> {
  ...
  public UpdateCristinProjectHandler(HttpClient httpClient, Environment environment) {
    this(
        new UpdateCristinProjectApiClient(httpClient),
        new FetchCristinProjectApiClient(httpClient),
        environment);
  }

  /** Creating the handler instance with required parameters. */
  public UpdateCristinProjectHandler(
      UpdateCristinProjectApiClient cristinApiClient,
      FetchCristinProjectApiClient fetchApiClient,
  ...
  private boolean missingHandlerOrResourceAccess(RequestInfo requestInfo)
      throws ApiGatewayException {
  ...
  protected boolean hasResourceAccess(RequestInfo requestInfo) throws ApiGatewayException {
    ...
    resourceAccessCheck.verifyAccess(
        projectFromUpstream, Map.of(USER_IDENTIFIER, extractCristinIdentifier(requestInfo)));
