...
/**
 * Parameter definistions <a
 * href="https://api.cristin-test.uio.no/v2/doc/index.html#GETprojects">...</a>.
 */
public class QueryProject extends CristinQuery<ParameterKeyProject> {
  ...
  protected String toCristinQueryValue(Entry<ParameterKeyProject, String> entry) {
    var value =
        entry.getKey().encoding() == KeyEncoding.ENCODE_DECODE
  ...
  protected String[] getCristinPath() {
    return containsKey(PATH_PROJECT)
