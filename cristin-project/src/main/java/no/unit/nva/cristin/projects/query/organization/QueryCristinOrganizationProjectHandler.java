...
public class QueryCristinOrganizationProjectHandler
    extends CristinQueryHandler<Void, SearchResponse<NvaProject>> {

  public static final Set<String> VALID_QUERY_PARAM_NO_VALIDATION =
      Set.of(
          INSTITUTION.getNvaKey(),
          PROJECT_MANAGER.getNvaKey(),
          PARTICIPANT.getNvaKey(),
          KEYWORD.getNvaKey(),
          FUNDING_SOURCE.getNvaKey(),
          FUNDING.getNvaKey(),
          APPROVAL_REFERENCE_ID.getNvaKey(),
          APPROVED_BY.getNvaKey(),
          PAGE_SORT.getNvaKey(),
          PROJECT_UNIT.getNvaKey(),
          USER.getNvaKey(),
          LANGUAGE.getNvaKey(),
          LEVELS.getNvaKey(),
          BIOBANK.getNvaKey(),
          MODIFIED_SINCE.getNvaKey());
  ...
  protected QueryCristinOrganizationProjectHandler(
      QueryCristinOrganizationProjectApiClient cristinApiClient, Environment environment) {
