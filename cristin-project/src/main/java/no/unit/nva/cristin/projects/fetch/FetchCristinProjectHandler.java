...
public class FetchCristinProjectHandler extends CristinHandler<Void, NvaProject> {
  ...
  public FetchCristinProjectHandler(
      FetchCristinProjectApiClient cristinApiClient, Environment environment) {
  ...
  private boolean doesNotHaveResourceAccess(RequestInfo requestInfo, NvaProject requestedProject)
    ...
    ResourceAccessCheck<NvaProject> resourceAccessCheck =
        new FetchCristinProjectResourceAccessCheck();
    resourceAccessCheck.verifyAccess(
        requestedProject, Map.of(USER_IDENTIFIER, extractCristinIdentifier(requestInfo)));
