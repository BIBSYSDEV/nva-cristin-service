...
public class CristinApprovalAuthorityBuilder
    implements EnumBuilder<CristinApproval, ApprovalAuthority> {
  ...
  public static final String NORWEGIAN_ANIMAL_RESEARCH_AUTHORITY =
      "NorwegianAnimalResearchAuthority";
  public static final String CRISTIN_NDPA = "NDPA";
  public static final String NORWEGIAN_DATA_PROTECTION_AUTHORITY =
  ...
  private static Map<String, String> mapValues() {
    return Map.of(
        CRISTIN_REK, REGIONAL_ETHICAL_COMMITTEES,
