...
public class FetchCristinProjectApiClient extends CristinProjectApiClient {
  ...
  /**
   * Creates a NvaProject object containing a single transformed Cristin Project. Is used for
  ...
  private BadGatewayException projectHasNotValidContent(String id) {
    ...
    return new BadGatewayException(
        String.format(ERROR_MESSAGE_CRISTIN_PROJECT_MATCHING_ID_IS_NOT_VALID, id));
  }
}
