...
public class FetchCristinProjectHandlerAccessCheck extends ProjectHandlerAccessCheck
    implements HandlerAccessCheck {

  private static final Logger logger =
      LoggerFactory.getLogger(FetchCristinProjectHandlerAccessCheck.class);
