...
class DeletePersonEmploymentHandlerTest {
  ...
  void setUp() throws IOException, InterruptedException {
    when(httpClientMock.<String>send(any(), any()))
        .thenReturn(new HttpResponseFaker(EMPTY_JSON, 200));
  ...
  private InputStream getInputStreamRequestWithInvalidPersonId() throws JsonProcessingException {
    ...
    return new HandlerRequestBuilder<CristinPersonEmployment>(OBJECT_MAPPER)
        ...
        .withBody(null)
        .withPathParameters(
            Map.of(PERSON_ID, INVALID_PERSON_ID, EMPLOYMENT_ID, VALID_EMPLOYMENT_ID))
        .build();
  }

  private InputStream getInputStreamRequestWithInvalidEmploymentId()
    ...
    return new HandlerRequestBuilder<CristinPersonEmployment>(OBJECT_MAPPER)
        ...
        .withBody(null)
        .withPathParameters(
            Map.of(PERSON_ID, VALID_PERSON_ID, EMPLOYMENT_ID, INVALID_EMPLOYMENT_ID))
        .build();
  }
}
