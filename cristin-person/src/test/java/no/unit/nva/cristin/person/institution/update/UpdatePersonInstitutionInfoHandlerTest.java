...
public class UpdatePersonInstitutionInfoHandlerTest {
    ...
    void shouldReturnNoContentResponseWhenCallingHandlerWithValidData() throws IOException {
        PersonInstitutionInfo personInstitutionInfo =
            new PersonInstitutionInfo(null, randomString(), randomString());

        GatewayResponse<String> gatewayResponse = sendQuery(validPath, personInstitutionInfo);
    ...
    void shouldThrowForbiddenExceptionWhenClientIsNotAuthenticated() throws IOException {
        ...
        GatewayResponse<String> gatewayResponse = queryWithoutRequiredAccessRights(personInstitutionInfo);
    ...
    private GatewayResponse<String> sendQuery(Map<String, String> pathParam, PersonInstitutionInfo body)
        throws IOException {
    ...
    private InputStream createRequest(Map<String, String> pathParam, PersonInstitutionInfo body)
        throws JsonProcessingException {

        return new HandlerRequestBuilder<PersonInstitutionInfo>(OBJECT_MAPPER)
            .withBody(body)
    ...
    private GatewayResponse<String> queryWithoutRequiredAccessRights(PersonInstitutionInfo body) throws IOException {
        InputStream input = new HandlerRequestBuilder<PersonInstitutionInfo>(OBJECT_MAPPER)
            .withBody(body)
