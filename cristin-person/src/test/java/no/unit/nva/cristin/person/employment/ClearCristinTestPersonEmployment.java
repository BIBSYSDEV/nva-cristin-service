...
public class ClearCristinTestPersonEmployment {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(ClearCristinTestPersonEmployment.class);
  private static final String ERROR_NOT_VALID_IDENTIFIERS =
      "Identifier for person: {} and/or employment: {} is not " + "valid, aborting deletion";
  ...
  public static void clearEmployment(String personId) throws ApiGatewayException {
    var queryResponse =
        new QueryPersonEmploymentClient(CristinAuthenticator.getHttpClient())
            .generateQueryResponse(personId);
