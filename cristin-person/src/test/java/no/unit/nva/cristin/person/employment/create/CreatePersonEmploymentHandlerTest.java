...
public class CreatePersonEmploymentHandlerTest {
  ...
  private GatewayResponse<Employment> sendBackendClientQuery(Employment employment)
      throws IOException {
    var query =
        new HandlerRequestBuilder<Employment>(OBJECT_MAPPER)
            .withBody(employment)
  ...
  void shouldThrowBadRequestWhenInvalidPositionCode() throws IOException, URISyntaxException {
    ...
    assertThat(
        ...
        containsString(ErrorMessages.invalidFieldParameterMessage(TYPE)));
  }
  ...
  void shouldThrowBadRequestWhenInvalidAffiliation() throws IOException, URISyntaxException {
    ...
    assertThat(
        gatewayResponse.getBody(),
        containsString(ErrorMessages.invalidFieldParameterMessage(ORGANIZATION)));
  }
  ...
  private InputStream createRequest(Employment body) throws JsonProcessingException {
  ...
  private GatewayResponse<Employment> sendQueryWithCristinOrgId(Employment body)
      throws IOException {
    var customerId = randomUri();
    var input =
        new HandlerRequestBuilder<Employment>(OBJECT_MAPPER)
  ...
  private GatewayResponse<Employment> queryAsAppAdmin(Employment body) throws IOException {
    var customerId = randomUri();
    var input =
        new HandlerRequestBuilder<Employment>(OBJECT_MAPPER)
            .withBody(body)
