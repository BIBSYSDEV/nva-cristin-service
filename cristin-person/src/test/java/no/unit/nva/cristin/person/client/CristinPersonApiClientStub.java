...
public class CristinPersonApiClientStub extends CristinPersonApiClient {
  ...
  public static final String CRISTIN_GET_PERSON_RESPONSE_JSON_FILE =
      "cristinGetPersonResponse.json";
  public static final String CRISTIN_QUERY_PERSONS_RESPONSE_JSON_FILE =
      "cristinQueryPersonResponse.json";
  private final String getResponseBody;
  private final String queryResponseBody;

  public CristinPersonApiClientStub() {
    this(
        IoUtils.stringFromResources(Path.of(CRISTIN_GET_PERSON_RESPONSE_JSON_FILE)),
