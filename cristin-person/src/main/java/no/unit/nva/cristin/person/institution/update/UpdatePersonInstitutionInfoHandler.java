...
public class UpdatePersonInstitutionInfoHandler
    extends PersonInstitutionInfoHandler<PersonInstInfoPatch, String> {

  private static final Logger logger =
      LoggerFactory.getLogger(UpdatePersonInstitutionInfoHandler.class);
  ...
  public UpdatePersonInstitutionInfoHandler() {
    this(
        new UpdatePersonInstitutionInfoClient(CristinAuthenticator.getHttpClient()),
        new Environment());
  }

  @JacocoGenerated
  public UpdatePersonInstitutionInfoHandler(
      UpdatePersonInstitutionInfoClient apiClient, Environment environment) {
  ...
  protected void validateRequest(
      PersonInstInfoPatch input, RequestInfo requestInfo, Context context)
