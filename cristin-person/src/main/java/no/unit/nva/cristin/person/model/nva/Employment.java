...
public class Employment implements JsonSerializable, UriId {
  ...
  /**
   * Returns an Optional containing either extracted position code if valid type URI otherwise
   * empty.
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(getContext(), that.getContext())
        ...
        && Objects.equals(
            getFullTimeEquivalentPercentage(), that.getFullTimeEquivalentPercentage());
  }
