...
public class UpdatePictureApiClient extends ApiClient {
  ...
  public static final String IDENTIFIER_OR_PAYLOAD_IS_NOT_VALID =
      "Supplied identifier or payload is not valid";
  public static final String UNSUPPORTED_MEDIA_TYPE_ERROR_MESSAGE =
      "Upstream returned unsupported media type";
   ...
   */
  private void checkPutHttpStatusCode(URI uri, int statusCode, String body)
