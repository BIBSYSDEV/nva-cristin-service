...
public class CristinPersonApiClient extends ApiClient
   ...
   * @throws ApiGatewayException when transformation from response fails
   */
  public List<CristinPerson> getEnrichedPersonsWithNinUsingQueryResponse(
      HttpResponse<String> response) throws ApiGatewayException {
  ...
  @Override
  public SearchResponse<Person> executeQuery(Map<String, String> params)
      throws ApiGatewayException {
    return generateQueryResponse(params);
  }

  @Override
  public SearchResponse<Person> executeAuthorizedQuery(Map<String, String> params)
      throws ApiGatewayException {
    return authorizedGenerateQueryResponse(params);
  }

  protected List<CristinPerson> combineResultsWithQueryInCaseEnrichmentFails(
      List<CristinPerson> personsFromQuery, List<CristinPerson> enrichedPersons) {
   ...
   */
  public HttpResponse<String> queryPersons(Map<String, String> parameters)
      throws ApiGatewayException {
  ...
  protected URI generateQueryPersonsUrl(Map<String, String> parameters) {
    var cristinPersonQuery =
        new CristinPersonQuery()
   ...
   * @throws ApiGatewayException if something went wrong
   */
  public SearchResponse<Person> authorizedGenerateQueryResponse(
  ...
  protected boolean allPersonsWereEnriched(
      List<CristinPerson> personsFromQuery, List<CristinPerson> enrichedCristinPersons) {
  ...
  public List<Person> authorizedMappingCristinPersonsToNvaPersons(
      List<CristinPerson> cristinPersons) {
    return cristinPersons.stream()
        .map(CristinPerson::toPersonWithAuthorizedFields)
        .collect(Collectors.toList());
  }
  ...
  public Person generateGetResponse(String identifier) throws ApiGatewayException {
    return getCristinPerson(identifier).toPersonBuilder().withContext(PERSON_CONTEXT).build();
  }
   ...
   */
  public Person getPersonFromNationalIdentityNumber(String nationalIdentificationNumber)
      throws ApiGatewayException {
  ...
  protected void throwNotFoundIfNoMatches(List<CristinPerson> cristinPersons)
