...
public class CristinOrganizationPersonsClient extends CristinPersonApiClient {
  ...
  public SearchResponse<Person> authorizedGenerateQueryResponse(
    ...
    return getPersonSearchResponse(
        requestQueryParams, startRequestTime, response, personsWithAuthorizedFields);
  }

  private SearchResponse<Person> getPersonSearchResponse(
   ...
   */
  private HttpResponse<String> queryOrganizationPersons(Map<String, String> parameters)
      throws ApiGatewayException {
