...
public class UpdatePersonEmploymentHandler extends ApiGatewayHandler<String, Void> {
  ...
  public UpdatePersonEmploymentHandler(
      UpdatePersonEmploymentClient apiClient, Environment environment) {
  ...
  protected Void processInput(String input, RequestInfo requestInfo, Context context)
    ...
    return apiClient.updatePersonEmploymentInCristin(
        personId, employmentId, cristinJson, extractCristinInstitutionIdentifier(requestInfo));
  }
