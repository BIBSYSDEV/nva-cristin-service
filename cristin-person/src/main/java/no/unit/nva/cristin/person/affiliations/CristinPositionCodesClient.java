...
public class CristinPositionCodesClient extends ApiClient {
  ...
  public static final URI CONTEXT =
      URI.create("https://bibsysdev.github.io/src/position-context.json");
  ...
  private List<CristinPositionCode> filterPositionCodeIfRequested(
      List<CristinPositionCode> cristinPositionCodes, Boolean positionStatus) {
    return positionStatus == null
        ? cristinPositionCodes
        : cristinPositionCodes.stream()
  ...
  private Set<PositionCode> mapPositionCodesToNva(List<CristinPositionCode> cristinPositionCodes) {
    return cristinPositionCodes.stream()
        .map(CristinPositionCode::toPositionCode)
