...
public class PositionCodesHandler extends ApiGatewayHandler<Void, PositionCodes> {
  ...
  private Boolean extractPositionCodeStatusQueryParam(RequestInfo requestInfo)
      throws BadRequestException {
    var activeStatusQueryParam =
        requestInfo.getQueryParameterOpt(ACTIVE_STATUS_QUERY_PARAM).orElse(null);

    return StringUtils.isEmpty(activeStatusQueryParam)
        ? null
