...
public class DeletePersonEmploymentHandler extends ApiGatewayHandler<Void, Void> {
  ...
  public DeletePersonEmploymentHandler(
      DeletePersonEmploymentClient apiClient, Environment environment) {
  ...
  protected Void processInput(Void input, RequestInfo requestInfo, Context context)
    ...
    return apiClient.deletePersonEmployment(
        personId, employmentId, extractCristinInstitutionIdentifier(requestInfo));
  }
