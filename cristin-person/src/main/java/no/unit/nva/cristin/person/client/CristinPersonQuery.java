...
public class CristinPersonQuery {
  ...
  public CristinPersonQuery() {
    ...
    cristinQueryParameters.put(
        CRISTIN_QUERY_PARAMETER_PAGE_KEY, CRISTIN_QUERY_PARAMETER_PAGE_DEFAULT_VALUE);
    cristinQueryParameters.put(
        CRISTIN_QUERY_PARAMETER_PER_PAGE_KEY, CRISTIN_QUERY_PARAMETER_PER_PAGE_DEFAULT_VALUE);
  }
  ...
  public static URI fromOrcid(String orcid) {
    ...
    return UriWrapper.fromUri(CRISTIN_API_URL).addChild(PERSON_PATH).addChild(identifier).getUri();
  }
