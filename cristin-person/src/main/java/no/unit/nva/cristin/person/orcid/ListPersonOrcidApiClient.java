...
public class ListPersonOrcidApiClient extends ApiClient
    implements FetchApiClient<Void, PersonsOrcid> {
  ...
  private List<PersonOrcid> getPersonsOrcid(HttpResponse<String> response)
