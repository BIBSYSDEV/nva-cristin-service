...
public class PersonPatchFieldFilter {
  ...
  /**
   * Filters on given institution number. Payload needs to be validated first to verify it contains
   * valid data. Automatically filters out data that cannot be updated without instNr if supplied
   * instNr is null.
   */
