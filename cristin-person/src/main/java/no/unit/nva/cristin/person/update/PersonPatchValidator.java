...
public final class PersonPatchValidator {
  ...
  public static final String COULD_NOT_PARSE_EMPLOYMENT_FIELD =
      "Could not parse employment field because of " + "invalid data";
  private static final String EXCEPTION_WHEN_VALIDATING_EMPLOYMENTS =
      "Exception when validating employments: {}";
  private static final String EXCEPTION_WHEN_VALIDATING_KEYWORDS =
      "Exception when validating keywords: {}";
  public static final String COULD_NOT_PARSE_KEYWORD_FIELD =
      "Could not parse keyword field because of " + "invalid data";
  public static final String EXCEPTION_WHEN_VALIDATING_PERSON_NVI =
      "Exception when validating personNvi: {}";
  public static final String COULD_NOT_PARSE_NVI_FIELD =
      "Could not parse personNvi field because of invalid data";
  ...
  private static final String EXCEPTION_WHEN_VALIDATING_COUNTRIES =
      "Exception when validating countries: {}";
  public static final String COULD_NOT_PARSE_COUNTRIES_FIELD =
      "Could not parse countries field because of " + "invalid data";
  public static final String EXCEPTION_WHEN_VALIDATING_AWARDS =
      "Exception when validating awards: {}";
  public static final String COULD_NOT_PARSE_AWARDS_FIELD =
      "Could not parse awards field because of invalid data";
  ...
  public static void validateOrcidIfPresent(ObjectNode input) throws BadRequestException {
    if (input.has(ORCID)
        && !input.get(ORCID).isNull()
        && !Utils.isOrcid(input.get(ORCID).asText())) {
  ...
  private static void validateNotNullIfPresent(ObjectNode input, String fieldName)
