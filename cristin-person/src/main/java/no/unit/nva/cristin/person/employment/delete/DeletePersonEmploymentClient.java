...
public class DeletePersonEmploymentClient extends ApiClient {
  ...
  public static final String NOT_FOUND_REQUEST_FROM_UPSTREAM =
      "Upstream returned Not Found. This might occur if "
   ...
   */
  public Void deletePersonEmployment(
      String personId, String employmentId, String cristinInstitutionNumber)
  ...
  private HttpResponse<String> deleteResults(URI uri, String cristinInstitutionNumber)
      throws ApiGatewayException {
    var httpRequest =
