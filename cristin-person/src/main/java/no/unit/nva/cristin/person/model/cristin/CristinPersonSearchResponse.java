...
public record CristinPersonSearchResponse(CristinPerson[] data, Map<String, CristinFacet[]> facets)
    implements CristinSearchResponse<CristinPerson[]> {

  @JsonCreator
  public CristinPersonSearchResponse(
      @JsonProperty("data") CristinPerson[] data,
